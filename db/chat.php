...
define( "HEADER", "React or Vue JS?" ); //Заголовок
define( "COOKIEPATH", "/" );
define( "CHATTRIM", 0 ); //Максимальная длина пересылаемого куска чата, 0 - без ограничений
define( "MAXUSERNAMELEN", 32 ); //Максимальная длина имени пользователя
define( "MAXUSERTEXTLEN", 115 ); //Максимальная длина сообщения пользователя
...
<head>
	...
	<link rel="stylesheet" href="../styletopic.css">
	<link href="./styletopic.css" rel="stylesheet">
	<link href="https://fonts.cdnfonts.com/css/craftwork-grotesk" rel="stylesheet">
	<link href="./favicon.ico" rel="icon" type="image/x-icon">
</head>
<?php require('./header-topics.php'); ?>
		<div id="wrapper">
			...
			<section class="topic-main-card">
                ...
                <div class="topic-overview">
					<h2 class="topic-info" style="margin-top: 20px; margin-buttom: 20px; font-size: 20px;
    line-height: 22px;"><?= $question?></h2>
			...
			<div id="msgsDialog" class="block">
				<section class="comment-feed">
					<form  class="comments-form" action="" method="post" id="sendForm">
						...
						<input  class="name-field" type="text" name="name" value="<?php echo $_SESSION['session_username'];?>" maxlength="<?php echo( MAXUSERNAMELEN ) ?>" placeholder="Имя" readonly/>
							<textarea class="comments-field" name="text" placeholder="Текст" style= maxlength="<?php echo( MAXUSERTEXTLEN ); ?>"></textarea>
